            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                            ...
                            child: Stack(
                              ...
                              children:[
                                ClipRRect(
                                  borderRadius: BorderRadius.circular(10),
                                  child: ColorFiltered(
                                  colorFilter: ColorFilter.mode(Colors.black54.withOpacity(0.3), BlendMode.multiply),
                                  child: Container(
                                    height: 60,
                                    decoration: BoxDecoration(
                                        color: Colors.white,
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(index==0?"#Chinese":
                                    index==1?"#Super Market":"#Groceries",style: const TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: Colors.white),)
                                  ],
                                )
                              ],
                            ),
                  ...
                  /// nearby restaurant
                  const Text("Nearby Restaurant",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
                  ...
                  ListView.builder(
                    ...
                    shrinkWrap: true,
                      itemBuilder: (context,index){
                        return RestaurantItem(imagePath: index==0?"assets/demo_one.jpg":
                        index==1?"assets/demo_two.jpg":
                        "assets/demo_three.jpg",);
                      }),
                  const SizedBox(height: 15,),
                  /// nearby shop
                  const Text("Nearby Shop",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
                  ...
                  ListView.builder(
                    itemCount: 3,
                      ...
                      padding: const EdgeInsets.only(top: 0),
                      itemBuilder: (context,index){
                        return RestaurantItem(imagePath: index==0?"assets/demo_two.jpg":
                        index==1?"assets/demo_one.jpg":
                        "assets/demo_three.jpg");
                      }),
                ],
              ),
