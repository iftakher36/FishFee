            ...
            children: [
              Stack(
                children: [
                  ...
                  Padding(
                    padding:
                    EdgeInsets.only(top: value-20<0?0:value-20, left: 20, right: 20),
                    child: Container(
                      height: 50,
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: IconButton(onPressed: (){}, icon: const Icon(Icons.keyboard_arrow_right_rounded,color: Colors.white,)),
                                      ),
                                    ],
                                  )
                                ],
